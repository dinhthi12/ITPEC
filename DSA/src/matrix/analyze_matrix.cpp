/**
*Given a matrix of size R x C (R rows, C columns), containing integers representing heights.
*
*You need to return:
*
*The tallest number among the shortest people in each row
(called max_of_row_mins)
*
*The lowest number among the tallest people in each column
(called min_of_col_maxes)
 */
